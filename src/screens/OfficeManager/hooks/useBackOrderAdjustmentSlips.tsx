...
export const useBackOrderAdjustmentSlips = () => {
	// STATES
	...
	// REQUEST METHODS
	const listBackOrderAdjustmentSlips = (data, shouldReset = false) => {
	...
	const createBackOrderAdjustmentSlip = (data, extraCallback = null) => {
		createAction({
			...data,
