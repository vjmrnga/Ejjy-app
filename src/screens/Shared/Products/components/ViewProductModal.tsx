	...
	return (
		...
		>
			<DetailsRow>
				...
				<DetailsSingle label="TT-002" value={getUnitOfMeasurement(product?.unit_of_measurement)} />
				<DetailsSingle label="TT-003" value={product?.is_vat_exempted ? 'VAT-EXEMPTED' : 'VAT'} />
				...
				<DetailsSingle label="Allowable Spoilage (%)" value={product?.allowable_spoilage * 100} />
